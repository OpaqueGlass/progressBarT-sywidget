...
> 当前版本： v0.2.6
> **改进**：兼容思源v3.7.0起调整界面语言标识的变动；（[REF](https://ld246.com/article/1781888259074)）
>
...
- 挂件在各种情况下的宽高`widgetTimeModeHeight`、`widgetAutoModeWithTimeRemainHeight`、`widgetTimeModeHeight`、`widgetHeight`；
